...
require (
	...
	github.com/elastic/beats/v7 v7.0.0-alpha2.0.20250104063751-e3e23320e5d7
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/exporter/elasticsearchexporter v0.114.0 // indirect
